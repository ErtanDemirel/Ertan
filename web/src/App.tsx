...
import InternalPostingsPage from './pages/InternalPostings';
...
import SelfPostings from './pages/self/SelfPostings';
  ...
  return (
    <Routes>
      ...
      <Route path="/" element={<ManagerGuard><Layout /></ManagerGuard>}>
        ...
        <Route path="postings" element={<InternalPostingsPage />} />
      ...
      <Route path="/me" element={<AuthGuard><SelfLayout /></AuthGuard>}>
        ...
        <Route path="postings" element={<SelfPostings />} />
