...
import { CalendarDays, Megaphone, UtensilsCrossed, Wallet, Bus, LogOut, ShieldCheck, MessagesSquare, Users, Clock, Calculator, Phone, CalendarCheck, GraduationCap, Briefcase } from 'lucide-react';
...
const tabs = [
  ...
  { to: '/me/postings', label: 'İç İlanlar', icon: Briefcase },
